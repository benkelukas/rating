...
class MigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Creates a migration following the Rating specifications.';
    /**
    ...
    {
        $migration_file = app_path('/database/migrations').'/'.date('Y_m_d_His').'_create_ratings_table.php';
